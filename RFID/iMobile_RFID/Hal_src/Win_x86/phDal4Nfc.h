 ...
 */   
typedef struct phDal4Nfc_sConfig
{
	/**< For example : com port is used for communication.This can be "COMx" where x can be 1,2 ..*/
    char *comPort; 
} phDal4Nfc_sConfig_t,*pphDal4Nfc_sConfig_t;
