...
namespace iMobileComPort
{
    ...
    #endregion
    #region StartCnfg
    public class StartCnfg
    {
        #region Members
        private string portName;
        private string motoPort;
        private string favPort;
        private uint startup;
        #endregion
        ...
        public void Load(string fName)
        {
            ...
            while ((line = sr.ReadLine()) != null)
            {
                data.TrimEnd(toTrim);
                data = line.Substring(line.IndexOf(":") + 1);
                if (line.StartsWith("<Start Port Name>"))
                    this.portName = data;
                else if (line.StartsWith("<MOTO Port Name>"))
                    this.MotoPort = data;
                else if (line.StartsWith("<FAV Port Name>"))
                    this.FavPort = data;
        ...
        /// <summary>
        /// Get/Set Startup mode, 0 normal, 1 minimize, 2 hide
        /// </summary>
        public uint Startup
        {
        ...
        public string MotoPort
        {
            get { return this.motoPort; }
            set { this.motoPort = value; }
        }
        public string FavPort
        {
            get { return this.favPort; }
            set { this.favPort = value; }
        }
        #endregion
    }
    #endregion
